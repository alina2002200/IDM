...
GH = Parameter(name = 'GH',
               nature = 'internal',
               type = 'real',
               value = '-0.08333333333333333*(G**2*(1 + (13*mmh**6)/(16800.*MMT**6) + mmh**4/(168.*MMT**4) + (7*mmh**2)/(120.*MMT**2)))/(cmath.pi**2*v)',
               texname = 'G_H')
